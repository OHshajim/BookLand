            ...
            <div className="card flex-col lg:flex-row bg-base-100 shadow-xl border border-[#13131326]">
                ...
                <div className="card-body">
                    ...
                    <div className="workSans">
                        ...
                        <div className="workSans md:flex items-center gap-3 space-y-3 md:space-y-0 text-base font-medium  mb-5">
                        ...
                        <div className="md:flex  gap-10 items-center space-y-3 md:space-y-0 mb-5">
